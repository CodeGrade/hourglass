...
import Part from '@examTaker/components/Part';
import { FileViewer } from '@examTaker/components/FileViewer';
import PaginationArrows from '@examTaker/containers/PaginationArrows';
import {
  TopScrollspy,
  BottomScrollspy,
} from '@examTaker/containers/scrollspy/Question';
import SubmitButton from '@examTaker/containers/SubmitButton';
