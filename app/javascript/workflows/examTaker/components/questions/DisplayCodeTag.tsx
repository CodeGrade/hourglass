...
import { FileRef, CodeTagInfo, CodeTagState } from '@examTaker/types';
import {
  Row, Col, Modal, Button,
} from 'react-bootstrap';
import { ControlledFileViewer } from '@examTaker/components/FileViewer';
import HTML from '@examTaker/components/HTML';
import { CodeTagVal } from '@examTaker/components/questions/CodeTag';
