...
class FixRubricUniquenessIndices < ActiveRecord::Migration[6.0]
  ...
  def down
    change_table(:rubrics) do |t|
      t.remove_index name: 'unique_rubric_order_per_ev'
      t.remove_index name: 'unique_rubric_order_per_question'
      t.remove_index name: 'unique_rubric_order_per_part'
      t.remove_index name: 'unique_rubric_order_per_body_item'
      ...
      t.remove_index name: 'unique_rubric_root_coords_ev'
      t.remove_index name: 'unique_rubric_root_coords_questions'
      t.remove_index name: 'unique_rubric_root_coords_parts'
      t.remove_index name: 'unique_rubric_root_coords_body_items'
